(function () {
  ...
  var r = window,
    ...
    u = function (a, b) {
      t.addEventListener
        ? t.addEventListener(a, b, !1)
        : t.attachEvent && t.attachEvent("on" + a, b);
    };
    ...
    A = function (a, b) {
      ...
      switch (b) {
        ...
        case "path":
          ...
          a = a.split("/");
          a: if ((Array.prototype.indexOf, (b = a[a.length - 1]), (c = [])))
  ...
  function H(a) {
    ...
    for (var c = "", d = 0; ; ) {
      ...
      64 !== g &&
        ((c += String.fromCharCode(((e << 4) & 240) | (g >> 2))),
  ...
  function Y(a, b, c, d) {
    c.href &&
      ((a = V(a, b, c.href, void 0 === d ? !1 : d)), v.test(a) && (c.href = a));
  }
  function X(a, b, c) {
    if (c && c.action) {
      ...
      if ("get" === d) {
        ...
        "post" === d && ((a = V(a, b, c.action)), v.test(a) && (c.action = a));
    }
  }
  var J = function (a) {
      try {
    ...
    y = function (a, b, c, d, e) {
      if (!ea(Yd.get(b)) && !$d.get(b)) {
        ...
        if (c) {
          ...
          (c && 0 <= c.indexOf("/")) ||
            (c = (ca ? ca + "/34" : bd(!1) + "/plugins/ua/") + c);
          ca = ae(c);
          a = ca.protocol;
          d = M.location.protocol;
          if (
            ("https:" == a || a == d || ("http:" != a ? 0 : "http:" == d)) &&
            B(ca)
          ) {
            if ((ca = ca.url))
              (a = (a =
                ...
                e
                  ? ((e = ""),
                    ...
                    f.test(ca) &&
                      M.write("<script" + e + ' src="' + ca + '">\x3c/script>'))
                  : ((e = M.createElement("script")),
                    (e.type = "text/javascript"),
                    (e.async = !0),
                    (e.src = ca),
                    a && e.setAttribute("nonce", a),
                    (ca = M.getElementsByTagName("script")[0]),
